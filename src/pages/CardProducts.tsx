...
import { Plus, Pencil, Trash2, Copy, ImageIcon, Cards, ChevronRight } from 'lucide-react';
            ...
            (state.cardProducts || []).map(product => (
              ...
              >
                <div className="flex items-start gap-3">
                  <Cards className="w-4 h-4 text-muted-foreground mt-0.5 flex-shrink-0" />
        ...
        {selectedProduct ? (
          ...
          <div className="flex-1 flex items-center justify-center text-muted-foreground">
            <div className="text-center">
              <Cards className="w-12 h-12 mx-auto mb-4 opacity-50" />
